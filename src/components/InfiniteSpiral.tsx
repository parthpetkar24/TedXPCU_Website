    ...
    >
      <div className="infinite-spiral__stage" role="list" aria-label="Infinite spiral gallery">
        {normalizedItems.map((item, index) => {
          const content = (
            <div className={`infinite-spiral__flip-inner ${flippedCards[index] ? 'is-flipped' : ''}`}>
              <div className="infinite-spiral__flip-front">
                <img
              ...
              <div className="infinite-spiral__flip-back">
                <h3 className="infinite-spiral__back-title">{item.title}</h3>
                <p className="infinite-spiral__back-desc">{item.designation}</p>
              </div>
            </div>
          );
